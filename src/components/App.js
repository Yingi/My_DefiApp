...
class App extends Component {
  ...
  async loadBlockchainData(){
    ...
    // Fetch Network Id of the Ganache if its the blockchain you are using
    ...
    if(dappTokenData){
      ...
      console.log('Lets see Dapp Token Balance')
  ...
  async loadWeb3(){
    if(window.ethereum){
      ...
      window.alert('Non-Ethereum browser detected, You should consider try using MetaMask')
    }
  }
